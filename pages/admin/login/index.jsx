...
import AdminAuth from "../../../auth/admin/adminStoreAuth";
          ...
          >
            ...
            <Formik
              ...
              onSubmit={(data, { setSubmitting }) => {
                setTimeout(() => {
                  API.postAdminLogin(data).then((resp) => {
                    if (resp.data) {
                      setLogin(true);
            ...
            <div className="mt-5">
              <b
                onClick={() => router.push("/")}
                className="text-gray-400 text-sm cursor-pointer hover:text-gray-600 transition duration-300"
              >
